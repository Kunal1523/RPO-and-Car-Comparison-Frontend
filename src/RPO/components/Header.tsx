...
//   saveDraft: () => void;           // Save (update existing if currentDraftId exists)
//   saveDraftAsNew: () => void;      // Save as new draft (always new id)

//   publishToFinal: () => void;
//   onShare: () => void;

//   // ✅ Unsaved indicator (left of export)
...
//         <div className="flex items-center bg-gray-100 p-1 rounded-lg ml-1">
//           <button
...
//           <div
//             className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold rounded-lg border bg-amber-50 text-amber-700 border-amber-200"
//             title="You have unsaved draft changes"
//           >
//             <span className="w-1 h-2 rounded-full bg-amber-500" />
//             UNSAVED
//           </div>
//         )}
...
//           className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors border border-gray-200"
...
//             <button
//               onClick={onShare}
//               className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-purple-600 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors border border-purple-200"
//               type="button"
//             >
...
//             <button
//               onClick={clearDraft}
//               className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors border border-red-200"
...
//             {/* ✅ Split-button: DRAFT (Save / Save as new) */}
...
//                     saveDraft();
//                   }}
//                   className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors"
//                   type="button"
//                   title="Save Draft"
//                 >
...
//                   className="px-2 py-1.5 text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors border-l border-blue-200"
//                   type="button"
...
//               {draftMenuOpen && (
//                 <div
//                   className="absolute right-0 mt-2 w-52 bg-white border border-gray-200 rounded-lg shadow-lg z-[80] overflow-hidden"
//                   role="menu"
//                 >
//                   <button
//                     onClick={() => {
...
//                       saveDraft();
//                     }}
//                     className="w-full text-left px-3 py-2 text-xs text-black-700 hover:bg-gray-50"
//                     type="button"
//                     role="menuitem"
//                   >
//                     Save (update current)
...
//               className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold text-white bg-green-600 hover:bg-green-700 rounded-lg shadow-sm transition-colors"
//               type="button"
...
//             rightSidebarOpen ? "bg-blue-50 text-blue-600" : "text-gray-500 hover:bg-gray-100"
//           }`}
